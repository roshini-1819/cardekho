...
const PRIORITY_FIELDS: { key: keyof Preferences["priorities"]; label: string; hint: string }[] = [
        ...
        <div className="flex flex-wrap gap-2">
          {BODY_TYPES.map((b) => (
            <Chip
              ...
              onClick={() =>
                setPrefs((p) => ({ ...p, bodyTypes: toggle(p.bodyTypes, b) }))
              }
            >
              {b}
            </Chip>
        ...
        <div className="flex flex-wrap gap-2">
          {FUEL_TYPES.map((f) => (
            <Chip
              ...
              onClick={() =>
                setPrefs((p) => ({ ...p, fuelTypes: toggle(p.fuelTypes, f) }))
              }
            >
              {f}
            </Chip>
